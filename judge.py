...
def main():
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            fop = open(testfile).read().splitlines()
            true_true=0
            true_false = 0
            false_true = 0
            false_false = 0
            for i in fop:
                ...
                print(sentence)
                relation = 0
                en1pos = sentence.find(ent1)
                if en1pos == -1:
                    en1pos = 0
                en2pos = sentence.find(ent2)
                if en2pos == -1:
                    en2pos = 0
                output = []
            ...
            acc = float(true_true)/(true_true+true_false)
            print("F%.4f",F)
            print("acc%.4f",acc)
            print("precision%.4f",a1)
